...
import com.huanxin.applib.model.HXNotifier;
import com.huanxin.applib.model.HXSDKModel;
import com.huanxin.domain.RobotUser;
import com.huanxin.domain.User;
import com.huanxin.utils.CommonUtils;
import com.zcdh.mobile.R;
import com.zcdh.mobile.app.activities.messages.ChatActivity_;
        ...
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                if(event.getData() instanceof EMMessage){
                    ...
                    EMLog.d(TAG, "receive the event : " + event.getEvent() + ",id : " + message
                            .getMsgId());
                }
    ...
    protected HXNotifier.HXNotificationInfoProvider getNotificationListener() {
        ...
        return new HXNotifier.HXNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                //设置点击通知栏跳转事件
                Intent intent = new Intent(appContext, ChatActivity_.class);
...
//    }
    ...
    public void login(String username, String password, EMCallBackAdapter callback) {
