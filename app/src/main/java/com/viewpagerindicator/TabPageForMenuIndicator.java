 ...
 */
public class TabPageForMenuIndicator extends HorizontalScrollView implements PageIndicator {
	...
	public void setTabIconLocation(int newLocation) {
		if (location > LOCATION_BOTTOM || location < LOCATION_LEFT) throw new IllegalArgumentException("Invalid location");
	...
	public TabPageForMenuIndicator(Context context) {
		this(context, null);
	}

	public TabPageForMenuIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void addTab(int index, CharSequence text, int iconResId) {
		...
		tabView.setTextSize(getResources().getDimension(R.dimen.menu_title));
