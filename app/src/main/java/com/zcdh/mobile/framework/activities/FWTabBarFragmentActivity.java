...
public class FWTabBarFragmentActivity extends AppCompatActivity {
        ...
        rg_nav_content.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (rg_nav_content.getChildAt(checkedId) != null) {
                    ...
                    if (specialIndex) {
                        specialIndex = false;
                        int currentIndicatorLeft_first = screenWidth / mAdapter.getCount()
                        ...
                        TranslateAnimation animation = new TranslateAnimation(
                                currentIndicatorLeft,
                                rg_nav_content.getChildAt(checkedId)
                                        .getLeft(), 0f, 0f);
                        animation.setInterpolator(new LinearInterpolator());
                        animation.setDuration(200);
                        animation.setFillAfter(true);
                        ...
                        //记录当前 下标的距最左侧的 距离
                        currentIndicatorLeft = rg_nav_content.getChildAt(checkedId)
                                .getLeft();
                    }
    ...
    private void initNavigationHSV() {
        ...
        for (int i = 0; i < tabTitle.length; i++) {
            ...
            RadioButton rb = (RadioButton) mInflater
                    .inflate(R.layout.fw_tab_nav_radiogroup_item, null);
            rb.setId(i);
