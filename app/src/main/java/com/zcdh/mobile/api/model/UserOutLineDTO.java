...
*  UserOutLineDTO 
* 
*  Created Date: 2014-05-08 12:17:50 
*  
*/  
 ...
 */
public class UserOutLineDTO  implements Serializable { 
    /** 
     * 用户邮箱
     */
     ...
     * 图片上传的附件
     */
    private JobImgAttachDTO msgAttach  ; 
    /** 
     * 签名 1 签到，0 未签到
     */
    ...
    *设定图片上传的附件
    */
    public void setMsgAttach(JobImgAttachDTO msgAttach) { 
        this.msgAttach=msgAttach;
     }
    /**
    *获取设定图片上传的附件
    */
    public JobImgAttachDTO getMsgAttach() { 
