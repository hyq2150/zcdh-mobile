...
import com.zcdh.mobile.app.activities.base.PhotoBrowser_;
...
public class ActivityDispatcher {
     ...
     * 微博绑定zcdh_uid账号
     */
    public static void toBind(Context activity, String login_type,
     ...
     *            标识是否单选
     */
    public static void toIndustry(boolean single, Activity context) {
    ...
    public static void toParcitipantsIndustry(boolean single, int type, long fairID,
            Activity context) {
     ...
     * @param context
     */
    public static void toPost(boolean single, Activity context) {
    ...
    public static void toBasicInfo(Activity activity) {
        ...
        activity.startActivityForResult(intent, Constants.REQUEST_CODE_BASIC_INFO_CHANGE);
    }
    ...
    public static void toActivity(Activity activity, String class_name,
        ...
        if (activity_cls != null) {
            ...
            if (class_name
                    .equals("com.zcdh.mobile.app.activities.messages.ChatActivity_")) {
                //传入客服聊天账号,进入与客服聊天界面
                String adminName;
                if (K.AppVersion.appVersion.equals(K.AppVersion.Versions.release)) {
                    adminName=Constant.ADMIN_USERNAME_RELEASE;
                }else if(K.AppVersion.appVersion.equals(K.AppVersion.Versions.preview)){
                    adminName=Constant.ADMIN_USERNAME_PREVIEW;
                }else {
                    adminName=Constant.ADMIN_USERNAME_DEBUG;
                }
                intent.putExtra("userId", adminName);
            }
            activity.startActivityForResult(intent,Constants.REQUEST_CODE_MESSAGE);
        }
    ...
    public static void toPhotoBrowser(Activity activity, String imgUrl,
            String[] urls) {
        Intent intent = new Intent(activity, PhotoBrowser_.class);
