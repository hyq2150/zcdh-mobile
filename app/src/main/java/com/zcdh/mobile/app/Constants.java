...
public class Constants {
    ...
    public final static String kLOGIN_PWD = "klogin_pwd";
    ...
    public static final String APPCONFIG_CUSTOM_ITEM_CODE_MAIN = "001.001.001";
    public static final String APPCONFIG_CUSTOM_ITEM_CODE_INFORMATION = "001.001.002";
...
// 签到
    ...
    public static final int KGET_HUANXIN_ACCOUNT_SUCCESS = 5;//获取环信账号成功
    ...
    public final static String kAUTH_TYPE_HUBEI = "hb";
    ...
    public static final String kEVENT_NOTIFICATION_APPCONFIG = "kEVENT_NOTIFICATION_APPCONFIG";
    ...
    public static final int REQUEST_CODE_ACCOUNT_MANAGER = 0x103;

    public static final int REQUEST_CODE_BASIC_INFO_CHANGE =0x200 ;
    ...
    public static final int REQUEST_CODE_MESSAGE = 0x105;
