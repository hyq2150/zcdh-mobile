/**
 * 
 * @author jeason, 2014-4-22 下午2:46:43
 */
package com.zcdh.mobile.app.activities.vacation.payment;
...
public class WXPayActivity extends BaseActivity {
	private static final String TAG = "com.zcdh.payment.WXPayActivity";
		...
		protected void onPostExecute(GetAccessTokenResult result) {
			...
			if (result.localRetCode == LocalRetCode.ERR_OK) {
				Toast.makeText(WXPayActivity.this,
						R.string.get_access_token_succ, Toast.LENGTH_SHORT)
						.show();
				...
				Toast.makeText(
						...
						getString(R.string.get_access_token_fail,
								result.localRetCode.name()), Toast.LENGTH_SHORT)
						.show();
			}
		}
	...
	private class GetPrepayIdTask extends
		...
		protected void onPostExecute(GetPrepayIdResult result) {
			...
			if (result.localRetCode == LocalRetCode.ERR_OK) {
				Toast.makeText(WXPayActivity.this, R.string.get_prepayid_succ,
