...
public class K {
    ...
    public static class AppVersion {
        ...
        public static Versions appVersion = Versions.preview;
    }
    ...
    public static class Hosts {
        ...
        static {
            switch (AppVersion.appVersion) {
                ...
                case release: {
                    if (!ZcdhApplication.getInstance().getChannel().trim().equals("hubei")) {
                        UPGRADE_URL = "http://www.zcdhjob.com/upgrade.xml";
                        UPGRADE_DATA_URL = "http://www.zcdhjob.com/upgradeDatabase.xml";
                        HTTP_SERVER_ADDRESS = "http://113.106.12.199";
                        HTTP_SERVER_PORT = "81";
                        ...
                        //湖北服务器相关配置
                        UPGRADE_URL = "http://59.175.218.200:9093/upgrade.xml";
                        UPGRADE_DATA_URL = "http://59.175.218.200:9093/upgradeDatabase.xml";
                        HTTP_SERVER_ADDRESS = "http://59.175.218.200";
                        HTTP_SERVER_PORT = "9095";
                        SERVER_ADDRESS_DEFAULT = "59.175.218.200";
                        SERVER_PORT_DEFAULT = 3005;
                        USER_GUIDE_URL = "59.175.218.200:9093";
                    }
                }
            }
        }
