...
//				if (i == mCurrentPage - 1) {
//					Bitmap icon = ((BitmapDrawable) this.getContext().getResources().getDrawable(R.drawable.arrow_normal)).getBitmap();
//
//					canvas.drawBitmap(icon, bound.left - mTitlePadding + 3, bound.bottom - icon.getHeight() + mTopPadding * 2, new Paint());
//
//					canvas.drawText(pageTitle, 0, pageTitle.length(), bound.left + icon.getWidth(), bound.bottom + mTopPadding, mPaintText);
//
//				}
//
//				if (i == mCurrentPage + 1) {
//					Bitmap icon = ((BitmapDrawable) this.getContext().getResources().getDrawable(R.drawable.arrow_normal)).getBitmap();
//					canvas.drawBitmap(icon, bound.right - icon.getWidth() + 3, bound.bottom - icon.getHeight() + mTopPadding * 2, new Paint());
//					canvas.drawText(pageTitle, 0, pageTitle.length(), bound.left - icon.getWidth(), bound.bottom + mTopPadding, mPaintText);
//
//				}
