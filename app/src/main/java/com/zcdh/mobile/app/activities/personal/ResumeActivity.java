    ...
    private void bindInfoToView() {
        ...
        if (titleDTO != null) {
            ...
            if (!StringUtils.isBlank(titleDTO.getUserName())) {
                nameText.setText(
                        String.format(getString(R.string.employee_name), titleDTO.getUserName()));
                nameText.setTextColor(getResources().getColor(
                        R.color.font_color));
            } else {
                nameText.setText(String.format(getString(R.string.employee_name), "名字信息不完整"));
                nameText.setTextColor(getResources().getColor(R.color.grey));
            }

            // 人才类型
            if (!StringUtils.isBlank(titleDTO.getTalentTypeName())) {
                talentsCategoryText.setText(String.format(
                        getString(R.string.employee_type),
                        titleDTO.getTalentTypeName()));
            }

            //求职状态
            if (!TextUtils.isEmpty(titleDTO.getJobStautsName())) {
                jobStatus_content.setText(String.format(getString(R.string.employee_status),
    ...
    class ItemsAdapters extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == (itemsTitles.size() - 1)) {//企业黑名单
                ...
                h.checkImg.setImageResource(R.drawable.private07no);
                ...
                switch (position) {
                    case 0://基本信息
                        ...
                        if (full == 0) { // 非必填不完整
                            ...
                            h.checkImg.setImageResource(R.drawable.private01nro);

                        } else if (full == 1) { // 非必填完整

                            h.checkImg.setImageResource(R.drawable.private01yes);

                        } else if (full == 2) { // 必填项并且不完整

                            h.checkImg.setImageResource(R.drawable.private01no);
                    ...
                    case 1://求职意向
                        ...
                        if (full == 0) { // 非必填不完整
                            ...
                            h.checkImg.setImageResource(R.drawable.private02nro);

                        } else if (full == 1) { // 非必填完整

                            h.checkImg.setImageResource(R.drawable.private02yes);

                        } else if (full == 2) { // 必填项并且不完整

                            h.checkImg.setImageResource(R.drawable.private02no);
                    ...
                    case 2://工作经验
                        ...
                        if (full == 0) { // 非必填不完整
                            ...
                            h.checkImg.setImageResource(R.drawable.private03nro);

                        } else if (full == 1) { // 非必填完整

                            h.checkImg.setImageResource(R.drawable.private03yes);

                        } else if (full == 2) { // 必填项并且不完整

                            h.checkImg.setImageResource(R.drawable.private03no);
                    ...
                    case 3://教育经历
                        ...
                        if (full == 0) { // 非必填不完整
                            h.checkImg.setImageResource(R.drawable.private04nro);
                        } else if (full == 1) { // 非必填完整
                            h.checkImg.setImageResource(R.drawable.private04yes);
                        } else if (full == 2) { // 必填项并且不完整
                            h.checkImg.setImageResource(R.drawable.private04no);
                        } else if (full == 3) { // 必填项并且完整
                            h.checkImg.setImageResource(R.drawable.private04yes);
                        }
                        break;
                    case 4://职业技能
                        ...
                        if (full == 0) { // 非必填不完整
                            h.checkImg.setImageResource(R.drawable.private05nro);
                        } else if (full == 1) { // 非必填完整
                            h.checkImg.setImageResource(R.drawable.private05yes);
                        } else if (full == 2) { // 必填项并且不完整
                            h.checkImg.setImageResource(R.drawable.private05no);
                        } else if (full == 3) { // 必填项并且完整
                            h.checkImg.setImageResource(R.drawable.private05yes);
                        }
                        break;
                    case 5://实践经历
                        ...
                        if (full == 0) {
                            h.checkImg.setImageResource(R.drawable.practical);
                        } else if (full == 1) {
                            h.checkImg.setImageResource(R.drawable.practical_yes);
                        } else if (full == 2) {
                            h.checkImg.setImageResource(R.drawable.practical_no);
                        } else if (full == 3) {
                            h.checkImg.setImageResource(R.drawable.practical_yes);
                        }
                        break;
                    case 6://获奖经历
                        ...
                        if (full == 0) {
                            h.checkImg.setImageResource(R.drawable.winning);
                        } else if (full == 1) {
                            h.checkImg.setImageResource(R.drawable.winning_yes);
                        } else if (full == 2) {
                            h.checkImg.setImageResource(R.drawable.winning_no);
                        } else if (full == 3) {
                            h.checkImg.setImageResource(R.drawable.winning_yes);
                        }
                        break;
                    case 7://自我评价
                        ...
                        if (full == 0) { // 非必填不完整
                            h.checkImg.setImageResource(R.drawable.private06nro);
                        } else if (full == 1) { // 非必填完整
                            h.checkImg.setImageResource(R.drawable.private06yes);
                        } else if (full == 2) { // 必填项并且不完整
                            h.checkImg.setImageResource(R.drawable.private06no);
                        } else if (full == 3) { // 必填项并且完整
                            h.checkImg.setImageResource(R.drawable.private06yes);
                        }
                        break;
