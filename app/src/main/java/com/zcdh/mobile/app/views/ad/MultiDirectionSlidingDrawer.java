...
public class MultiDirectionSlidingDrawer extends LinearLayout {
    ...
    private final String TAG = "MultiDirectionSlidingDrawer";
    ...
    protected void onFinishInflate() {
        ...
        //	LinearLayout.LayoutParams ll = (LayoutParams) mHandle.getLayoutParams();
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mTracking || mAnimating) {
            ...
            //	Log.e(TAG,"dispatchDraw mExpanded...");
            drawChild(canvas, mContent, drawingTime);
        }
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mVertical) {
            //	handleLeft = ( width - handleWidth ) * 9 / 10;
            int density = (int) getResources().getDisplayMetrics().density;
            handleLeft = getResources().getDisplayMetrics().widthPixels - (int) (handleWidth
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_CANCEL: {
                    ...
                    if (vertical) {
                        ...
                        if ((!mInvert && xVelocity > mMaximumMinorVelocity) || (mInvert
                        ...
                        // fix by Maciej Ciemięga.
                        if ((!mInvert && yVelocity > mMaximumMinorVelocity) || (mInvert
                    ...
                    if (Math.abs(velocity) < mMaximumTapVelocity) {
                        ...
                        if (mInvert) {
                            ...
                            c2 = (!mExpanded
                                    && handleTop < mTopOffset + mHandleHeight - mTapThreshold);
                            c3 = (mExpanded
                                    && (getRight() - handleRight) < mTapThreshold + mBottomOffset);
                            c4 = (!mExpanded
                                    && handleLeft > mTopOffset + mHandleWidth + mTapThreshold);
                        } else {
...
//			scrollListener.onScrollEnded();
    ...
    private static class SlidingHandler extends Handler {
        ...
        private WeakReference<MultiDirectionSlidingDrawer> mReference;

        public SlidingHandler(MultiDirectionSlidingDrawer multiDirectionSlidingDrawer) {
            mReference = new WeakReference<>(
        ...
        public void handleMessage(Message m) {
            switch (m.what) {
                case MSG_ANIMATE:
                    MultiDirectionSlidingDrawer drawer = mReference.get();
                    if (drawer != null) {
                        drawer.doAnimation();
                    }
                    break;
